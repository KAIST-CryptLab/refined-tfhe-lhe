...
use crate::{utils::*, automorphism::*, automorphism128::*, mod_switch::*};
    ...
    AccCont: Container<Element=Scalar>,
{
    ...
    let log_polynomial_size = fourier_bsk.polynomial_size().0.ilog2() as usize;
...
pub fn pbs_to_glwe_by_trace<Scalar, InputCont, OutputCont, AccCont>(
    input: &LweCiphertext<InputCont>,
    output: &mut GlweCiphertext<OutputCont>,
    accumulator: &GlweCiphertext<AccCont>,
    fourier_bsk: FourierLweBootstrapKeyView<'_>,
