...
use hom_trace::{keygen_pbs_without_ksk, automorphism::*, fast_automorphism::*, ggsw_conv::*, utils::*};
...
fn main() {
    ...
    test_ggsw_conv_by_fast_trace_with_mod_switch(
        lwe_dimension,
        glwe_dimension,
        polynomial_size,
        lwe_modular_std_dev,
...
fn test_ggsw_conv_by_fast_trace_with_mod_switch(
    lwe_dimension: LweDimension,
    glwe_dimension: GlweDimension,
    polynomial_size: PolynomialSize,
    lwe_modular_std_dev: impl DispersionParameter,
    ...
    println!(
"==== GGSW conversion by fast trace with mod switch ====
n: {}, N: {}, k: {},
l_pbs: {}, B_pbs: 2^{}, l_ggsw: {}, B_ggsw: 2^{}, LutCount: 2^{},
l_auto: {}, B_auto: 2^{}, l_ss: {}, B_ss: 2^{}\n",
        lwe_dimension.0, polynomial_size.0, glwe_dimension.0,
    ...
    // Circuit Bootstrapping
    let now = Instant::now();
    let fourier_ggsw = circuit_bootstrap_lwe_ciphertext_by_fast_trace_with_mod_switch(
        lwe_in.as_view(),
        fourier_bsk,
        &fast_auto_keys,
        ss_key,
