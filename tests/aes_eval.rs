...
use hom_trace::{keygen_pbs, automorphism::*, automorphism128::*, ggsw_conv::*, aes_ref::*, aes_he::*};

fn main() {
    // AES evaluation by trace with mod switch
    ...
    test_aes_eval_by_trace_with_mod_switch(
        lwe_dimension,
        polynomial_size,
        glwe_dimension,
        lwe_modular_std_dev,
    ...
    // AES evaluation by trace128 and rescale
    test_aes_eval_by_trace128_and_rescale(
        lwe_dimension,
        polynomial_size,
        glwe_dimension,
        lwe_modular_std_dev,
    ...
    // AES evaluation by pksk
    let pksk_base_log = DecompositionBaseLog(12);
    let pksk_level = DecompositionLevelCount(2);

    test_aes_eval_by_pksk(
        lwe_dimension,
        polynomial_size,
        glwe_dimension,
        lwe_modular_std_dev,
    ...
    // AES evaluation by trace
    let pbs_base_log = DecompositionBaseLog(12);
    let pbs_level = DecompositionLevelCount(3);

    test_aes_eval_by_trace(
        lwe_dimension,
        polynomial_size,
        glwe_dimension,
        lwe_modular_std_dev,
...
#[allow(unused)]
fn test_aes_eval_by_trace_with_mod_switch(
...
l_auto: {}, B_auto: 2^{}, l_ss: {}, B_ss: 2^{}\n",
    ...
    for r in 1..NUM_ROUNDS {
        ...
        // SubBytes
        let now = Instant::now();
        he_sub_bytes_by_trace_with_mod_switch(
            &mut he_state,
            &ksk,
            fourier_bsk,
            &auto_keys,
    ...
    let time_total = time_sub_bytes + time_linear;
    println!("Total   : {} s", time_total.as_millis() as f64 / 1000f64);
}

#[allow(unused)]
fn test_aes_eval_by_trace128_and_rescale(
    lwe_dimension: LweDimension,
    polynomial_size: PolynomialSize,
    glwe_dimension: GlweDimension,
    lwe_modular_std_dev: impl DispersionParameter,
...
l_auto: {}, B_auto: 2^{}, l_ss: {}, B_ss: 2^{}\n",
    ...
    for r in 1..NUM_ROUNDS {
        ...
        // SubBytes
        let now = Instant::now();
        he_sub_bytes_by_trace128_and_rescale(
            &mut he_state,
            &ksk,
            fourier_bsk,
            &auto128_keys,
