...
fn main() {
    // AES evaluation by trace with preprocessing
    ...
    test_aes_eval_by_trace_with_preprocessing(
        lwe_dimension,
        polynomial_size,
        glwe_dimension,
        lwe_modular_std_dev,
...
#[allow(unused)]
fn test_aes_eval_by_trace_with_preprocessing(
...
l_auto: {}, B_auto: 2^{}, l_ss: {}, B_ss: 2^{}\n",
    ...
    for r in 1..NUM_ROUNDS {
        ...
        // SubBytes
        let now = Instant::now();
        he_sub_bytes_by_trace_with_preprocessing(
            &mut he_state,
            &ksk,
            fourier_bsk,
            &auto_keys,
