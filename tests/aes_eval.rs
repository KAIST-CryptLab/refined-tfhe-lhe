...
use hom_trace::{keygen_pbs, automorphism::*, fast_automorphism::*, ggsw_conv::*, aes_ref::*, aes_he::*};
...
fn main() {
    ...
    test_aes_eval_by_fast_trace_with_mod_switch(
        lwe_dimension,
        polynomial_size,
        glwe_dimension,
        lwe_modular_std_dev,
...
#[allow(unused)]
fn test_aes_eval_by_fast_trace_with_mod_switch(
    lwe_dimension: LweDimension,
    polynomial_size: PolynomialSize,
    glwe_dimension: GlweDimension,
    lwe_modular_std_dev: impl DispersionParameter,
    ...
    println!(
"==== AES evaluation by fast trace with mod switch ====
n: {}, N: {}, k: {}, l_ks: {}, B_ks: 2^{}
l_pbs: {}, B_pbs: 2^{}, l_ggsw: {}, B_ggsw: 2^{}, LutCount: 2^{},
l_auto: {}, B_auto: 2^{}, l_ss: {}, B_ss: 2^{}\n",
        lwe_dimension.0, polynomial_size.0, glwe_dimension.0, ks_level.0, ks_base_log.0,
    ...
    for r in 1..NUM_ROUNDS {
        ...
        // SubBytes
        let now = Instant::now();
        he_sub_bytes_by_fast_trace_with_mod_switch(
            &mut he_state,
            &ksk,
            fourier_bsk,
            &fast_auto_keys,
