...
use hom_trace::{automorphism128::*, ggsw_conv::*, aes_ref::*, aes_he::*};
...
l_auto: {}, B_auto: 2^{}, l_ss: {}, B_ss: 2^{}\n",
    ...
    let lwe_sk = big_lwe_sk;
    let lwe_sk_after_ks = small_lwe_sk;

    let ksk = allocate_and_generate_new_lwe_keyswitch_key(&lwe_sk, &lwe_sk_after_ks, ks_base_log, ks_level, lwe_modular_std_dev, ciphertext_modulus, &mut encryption_generator);
